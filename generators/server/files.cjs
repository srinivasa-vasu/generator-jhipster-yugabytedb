...
// const { default: generator } = require('./generator.mjs');

/* Constants use throughout */
const { INTERPOLATE_REGEX, SERVER_MAIN_SRC_DIR, SERVER_MAIN_RES_DIR, SERVER_TEST_SRC_DIR, SERVER_TEST_RES_DIR, DOCKER_DIR, TEST_DIR } =
  constants;
...
const baseServerFiles = {
  ...
  serverJavaConfig: [
    ...
    {
      condition: generator => !generator.skipUserManagement || generator.databaseTypeSql,
      path: SERVER_MAIN_SRC_DIR,
  ...
  serverJavaUserManagement: [
    ...
    {
      condition: generator => !generator.skipUserManagement && generator.cucumberTests && !generator.databaseTypeCassandra,
      path: SERVER_TEST_SRC_DIR,
      templates: [
        {
